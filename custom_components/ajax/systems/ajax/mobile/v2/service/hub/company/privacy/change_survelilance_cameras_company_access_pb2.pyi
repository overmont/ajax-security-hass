...
class ChangeSurveillanceCamerasCompanyAccessRequest(_message.Message):
    ...
    def __init__(self, hub_id: _Optional[str] = ..., company_id: _Optional[str] = ..., company_rights: _Optional[_Union[_surveillance_cameras_company_rights_pb2.SurveillanceCamerasCompanyRights, _Mapping]] = ...) -> None: ...
...
class ChangeSurveillanceCamerasCompanyAccessResponse(_message.Message):
    ...
    def __init__(self, success: _Optional[_Union[_response_pb2.Success, _Mapping]] = ..., error: _Optional[_Union[ChangeSurveillanceCamerasCompanyAccessResponse.Error, _Mapping]] = ...) -> None: ...
