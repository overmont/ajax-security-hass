...
class HomeSiren(_message.Message):
    __slots__ = ("common_jeweller_part", "common_siren_part", "alarm_verification", "alarm_restriction", "post_alarm_indication_props", "device_battery", "device_temperature", "device_tamper_status", "common_standard_compliance_part", "group_association")
...
class HomeSirenG3(_message.Message):
    __slots__ = ("common_jeweller_part", "common_siren_part", "alarm_verification", "alarm_restriction", "post_alarm_indication_props", "device_battery", "device_temperature", "device_tamper_status", "common_standard_compliance_part", "group_association", "radio_interference_detection_part")
    COMMON_JEWELLER_PART_FIELD_NUMBER: _ClassVar[int]
    COMMON_SIREN_PART_FIELD_NUMBER: _ClassVar[int]
    ALARM_VERIFICATION_FIELD_NUMBER: _ClassVar[int]
    ALARM_RESTRICTION_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, common_jeweller_part: _Optional[_Union[_common_jeweller_part_pb2.CommonJewellerPart, _Mapping]] = ..., common_siren_part: _Optional[_Union[_common_siren_part_pb2.CommonSirenPart, _Mapping]] = ..., alarm_verification: _Optional[_Union[_alarm_verification_pb2.AlarmVerification, _Mapping]] = ..., alarm_restriction: _Optional[_Union[_alarm_restriction_pb2.AlarmRestriction, _Mapping]] = ..., post_alarm_indication_props: _Optional[_Union[_post_alarm_indication_pb2.PostAlarmIndication, _Mapping]] = ..., device_battery: _Optional[_Union[_device_battery_pb2.DeviceBatteryWithoutCharging, _Mapping]] = ..., device_temperature: _Optional[_Union[_device_temperature_pb2.DeviceTemperature, _Mapping]] = ..., device_tamper_status: _Optional[_Union[_device_tamper_status_pb2.DeviceTamperStatus, str]] = ..., common_standard_compliance_part: _Optional[_Union[_common_standard_compliance_part_pb2.CommonStandardCompliancePart, _Mapping]] = ..., group_association: _Optional[_Union[_group_association_pb2.GroupAssociation, _Mapping]] = ..., radio_interference_detection_part: _Optional[_Union[_radio_interference_detection_part_pb2.RadioInterferenceDetectionPart, _Mapping]] = ...) -> None: ...
