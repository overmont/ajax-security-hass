...
class MediaVisibility(_message.Message):
    ...
    class Whitelist(_message.Message):
        ...
        def __init__(self, allowed_id: _Optional[_Iterable[str]] = ...) -> None: ...
    ...
    def __init__(self, whitelist: _Optional[_Union[MediaVisibility.Whitelist, _Mapping]] = ..., allowed_for_everyone: _Optional[_Union[MediaVisibility.AllowedForEveryone, _Mapping]] = ...) -> None: ...
