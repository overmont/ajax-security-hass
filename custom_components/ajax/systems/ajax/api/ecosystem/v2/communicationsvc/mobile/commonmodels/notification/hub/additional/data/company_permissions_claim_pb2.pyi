...
class CompanyPermissionsClaim(_message.Message):
    __slots__ = ("request_id", "company_mail", "permissions_type")
    ...
    def __init__(self, request_id: _Optional[str] = ..., company_mail: _Optional[str] = ..., permissions_type: _Optional[_Union[_permission_claim_type_pb2.PermissionsClaimType, _Mapping]] = ...) -> None: ...
