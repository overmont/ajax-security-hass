...
class StorageDeviceInfo(_message.Message):
    ...
    def __init__(self, storage_device_id: _Optional[str] = ..., storage_device_port_number: _Optional[_Union[_storage_device_port_number_pb2.StorageDevicePortNumber, _Mapping]] = ...) -> None: ...
