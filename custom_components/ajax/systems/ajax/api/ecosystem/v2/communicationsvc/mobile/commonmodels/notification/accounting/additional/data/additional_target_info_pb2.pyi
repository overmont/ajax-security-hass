...
class AdditionalTargetInfo(_message.Message):
    ...
    def __init__(self, hub_info: _Optional[_Union[_hub_info_pb2.HubInfo, _Mapping]] = ..., video_edge_info: _Optional[_Union[_video_edge_info_pb2.VideoEdgeInfo, _Mapping]] = ...) -> None: ...
