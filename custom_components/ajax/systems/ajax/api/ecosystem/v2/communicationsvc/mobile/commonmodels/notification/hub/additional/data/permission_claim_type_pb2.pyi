...
class PermissionsClaimType(_message.Message):
    __slots__ = ("permanent", "temporary", "rejected")
    ...
    def __init__(self, permanent: _Optional[_Union[PermissionsClaimType.Permanent, _Mapping]] = ..., temporary: _Optional[_Union[PermissionsClaimType.Temporary, _Mapping]] = ..., rejected: _Optional[_Union[PermissionsClaimType.Rejected, _Mapping]] = ...) -> None: ...
