...
class VideoArchiveExportCompletedMedia(_message.Message):
    ...
    recordings: _containers.RepeatedCompositeFieldContainer[VideoArchiveExportCompletedMedia.VideoExportedRecording]
    def __init__(self, recordings: _Optional[_Iterable[_Union[VideoArchiveExportCompletedMedia.VideoExportedRecording, _Mapping]]] = ...) -> None: ...
