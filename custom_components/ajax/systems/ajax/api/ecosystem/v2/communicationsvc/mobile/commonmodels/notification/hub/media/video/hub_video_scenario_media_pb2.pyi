...
class HubVideoScenarioMedia(_message.Message):
    ...
    class ChannelAlarmFrameMetadata(_message.Message):
        ...
        def __init__(self, video_edge_id: _Optional[str] = ..., channel_id: _Optional[str] = ..., channel_name: _Optional[str] = ..., room_name: _Optional[str] = ..., frame_data_result: _Optional[_Union[HubVideoScenarioMedia.FrameDataResult, _Mapping]] = ...) -> None: ...
    class FrameDataResult(_message.Message):
        ...
        def __init__(self, url_list: _Optional[_Union[HubVideoScenarioMedia.UrlList, _Mapping]] = ..., permission_denied: _Optional[_Union[HubVideoScenarioMedia.PermissionDenied, _Mapping]] = ...) -> None: ...
    ...
    channel_metadata: _containers.RepeatedCompositeFieldContainer[HubVideoScenarioMedia.ChannelAlarmFrameMetadata]
    def __init__(self, channel_metadata: _Optional[_Iterable[_Union[HubVideoScenarioMedia.ChannelAlarmFrameMetadata, _Mapping]]] = ...) -> None: ...
