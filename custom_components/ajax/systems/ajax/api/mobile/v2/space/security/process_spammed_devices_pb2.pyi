...
class ProcessSpammedDevicesRequest(_message.Message):
    ...
    space_id: str
    spammed_hub_devices: _containers.RepeatedCompositeFieldContainer[_hub_device_pb2.HubDevice]
    def __init__(self, space_id: _Optional[str] = ..., spammed_hub_devices: _Optional[_Iterable[_Union[_hub_device_pb2.HubDevice, _Mapping]]] = ...) -> None: ...

class ProcessSpammedDevicesResponse(_message.Message):
    __slots__ = ("success", "failure")
    class Failure(_message.Message):
        __slots__ = ("bad_request", "space_not_found", "permission_denied", "another_transition_is_in_progress", "already_in_the_requested_security_state", "illegal_space_security_mode", "hub_offline", "hub_busy", "space_locked", "hub_not_allowed_to_perform_command", "bypass_failed")
