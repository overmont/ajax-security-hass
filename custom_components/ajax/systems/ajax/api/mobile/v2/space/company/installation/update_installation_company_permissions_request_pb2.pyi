...
class UpdateInstallationCompanyPermissionsRequest(_message.Message):
    __slots__ = ("space_id", "company_hex_id", "update")
    class PermissionsUpdate(_message.Message):
        __slots__ = ("space_permission_patch", "hub_permission_patch")
        ...
        space_permission_patch: _containers.RepeatedCompositeFieldContainer[UpdateInstallationCompanyPermissionsRequest.PermissionsUpdate.SpacePermissionPatch]
        hub_permission_patch: _containers.RepeatedCompositeFieldContainer[UpdateInstallationCompanyPermissionsRequest.PermissionsUpdate.HubPermissionPatch]
        def __init__(self, space_permission_patch: _Optional[_Iterable[_Union[UpdateInstallationCompanyPermissionsRequest.PermissionsUpdate.SpacePermissionPatch, _Mapping]]] = ..., hub_permission_patch: _Optional[_Iterable[_Union[UpdateInstallationCompanyPermissionsRequest.PermissionsUpdate.HubPermissionPatch, _Mapping]]] = ...) -> None: ...
    ...
    def __init__(self, space_id: _Optional[str] = ..., company_hex_id: _Optional[str] = ..., update: _Optional[_Union[UpdateInstallationCompanyPermissionsRequest.PermissionsUpdate, _Mapping]] = ...) -> None: ...
...
class UpdateInstallationCompanyPermissionsResponse(_message.Message):
    ...
    def __init__(self, success: _Optional[_Union[_response_pb2.Success, _Mapping]] = ..., failure: _Optional[_Union[UpdateInstallationCompanyPermissionsResponse.Failure, _Mapping]] = ...) -> None: ...
