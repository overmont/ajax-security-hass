...
class ArmSpaceGroupRequest(_message.Message):
    __slots__ = ("space_locator", "group_id", "ignore_alarms")
...
class ArmSpaceGroupResponse(_message.Message):
    ...
    class Failure(_message.Message):
        ...
        def __init__(self, bad_request: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., space_not_found: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., group_not_found: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., permission_denied: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., another_transition_is_in_progress: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., already_in_the_requested_security_state: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., illegal_space_security_mode: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., hub_offline: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., hub_busy: _Optional[_Union[_response_pb2.HubBusyError, _Mapping]] = ..., hub_blocked_by_service_provider: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., hub_alarm_reset_required: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., hub_detected_malfunctions: _Optional[_Union[_response_pb2.HubDetectedMalfunctionsError, _Mapping]] = ..., space_locked: _Optional[_Union[_response_pb2.SpaceLockedError, _Mapping]] = ..., action_is_limited_in_empty_space: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., hub_not_allowed_to_perform_command: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ...) -> None: ...
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    FAILURE_FIELD_NUMBER: _ClassVar[int]
    success: _response_pb2.Success
    failure: ArmSpaceGroupResponse.Failure
    def __init__(self, success: _Optional[_Union[_response_pb2.Success, _Mapping]] = ..., failure: _Optional[_Union[ArmSpaceGroupResponse.Failure, _Mapping]] = ...) -> None: ...
