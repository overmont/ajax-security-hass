...
class DeclineMonitoringResponse(_message.Message):
    ...
    def __init__(self, success: _Optional[_Union[DeclineMonitoringResponse.Success, _Mapping]] = ..., failure: _Optional[_Union[DeclineMonitoringResponse.Failure, _Mapping]] = ...) -> None: ...
