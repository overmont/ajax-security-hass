...
class GoToChannelPtzPresetResponse(_message.Message):
    ...
    class Failure(_message.Message):
        __slots__ = ("bad_request", "space_not_found", "permission_denied", "video_edge_not_found", "channel_not_found", "ptz_operation_not_supported", "ptz_temporary_unavailable", "ptz_preset_not_found", "video_edge_is_offline")
        ...
        def __init__(self, bad_request: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., space_not_found: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., permission_denied: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., video_edge_not_found: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., channel_not_found: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., ptz_operation_not_supported: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., ptz_temporary_unavailable: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., ptz_preset_not_found: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., video_edge_is_offline: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ...) -> None: ...
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    FAILURE_FIELD_NUMBER: _ClassVar[int]
    success: _response_pb2.Success
    failure: GoToChannelPtzPresetResponse.Failure
    def __init__(self, success: _Optional[_Union[_response_pb2.Success, _Mapping]] = ..., failure: _Optional[_Union[GoToChannelPtzPresetResponse.Failure, _Mapping]] = ...) -> None: ...
