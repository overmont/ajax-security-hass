...
class SetDiagnosticsLoggingOnRequest(_message.Message):
    __slots__ = ("video_edge_id", "logging_settings", "space_locator")
    ...
    def __init__(self, video_edge_id: _Optional[str] = ..., logging_settings: _Optional[_Union[_diagnostics_settings_pb2.LoggingSettings, _Mapping]] = ..., space_locator: _Optional[_Union[_space_locator_pb2.SpaceLocator, _Mapping]] = ...) -> None: ...
...
class SetDiagnosticsLoggingOnResponse(_message.Message):
    ...
    def __init__(self, success: _Optional[_Union[_response_pb2.Success, _Mapping]] = ..., failure: _Optional[_Union[SetDiagnosticsLoggingOnResponse.Failure, _Mapping]] = ...) -> None: ...
