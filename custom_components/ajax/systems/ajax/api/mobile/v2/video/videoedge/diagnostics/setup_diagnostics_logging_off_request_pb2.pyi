...
class SetDiagnosticsLoggingOffRequest(_message.Message):
    __slots__ = ("video_edge_id", "space_locator")
    VIDEO_EDGE_ID_FIELD_NUMBER: _ClassVar[int]
    SPACE_LOCATOR_FIELD_NUMBER: _ClassVar[int]
    video_edge_id: str
    space_locator: _space_locator_pb2.SpaceLocator
    def __init__(self, video_edge_id: _Optional[str] = ..., space_locator: _Optional[_Union[_space_locator_pb2.SpaceLocator, _Mapping]] = ...) -> None: ...
...
class SetDiagnosticsLoggingOffResponse(_message.Message):
    ...
    def __init__(self, success: _Optional[_Union[_response_pb2.Success, _Mapping]] = ..., failure: _Optional[_Union[SetDiagnosticsLoggingOffResponse.Failure, _Mapping]] = ...) -> None: ...
