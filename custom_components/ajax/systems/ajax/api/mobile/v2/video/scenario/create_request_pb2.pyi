...
class CreateScenarioRequest(_message.Message):
    __slots__ = ("space_locator", "name", "alarm_sources", "alarm_sources_condition", "targets", "monitoring_state")
    ...
    def __init__(self, space_locator: _Optional[_Union[_space_locator_pb2.SpaceLocator, _Mapping]] = ..., name: _Optional[str] = ..., alarm_sources: _Optional[_Iterable[_Union[_alarm_source_pb2.AlarmSource, _Mapping]]] = ..., alarm_sources_condition: _Optional[_Union[_alarm_sources_condition_pb2.AlarmSourcesCondition, _Mapping]] = ..., targets: _Optional[_Iterable[_Union[_target_video_edge_pb2.TargetVideoEdge, _Mapping]]] = ..., monitoring_state: _Optional[_Union[_target_video_edge_pb2.MonitoringState, str]] = ...) -> None: ...
...
class CreateScenarioResponse(_message.Message):
    ...
    class Failure(_message.Message):
        __slots__ = ("bad_request", "space_not_found", "permission_denied", "space_armed", "empty_source_list", "hub_not_found", "source_not_found", "target_channel_list_is_empty", "target_video_edge_not_found", "target_channel_not_found", "invalid_channel_state", "duplicated_name", "space_locked")
        ...
        def __init__(self, bad_request: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., space_not_found: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., permission_denied: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., space_armed: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., empty_source_list: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., hub_not_found: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., source_not_found: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., target_channel_list_is_empty: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., target_video_edge_not_found: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., target_channel_not_found: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., invalid_channel_state: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., duplicated_name: _Optional[_Union[_response_pb2.DefaultError, _Mapping]] = ..., space_locked: _Optional[_Union[_response_pb2.SpaceLockedError, _Mapping]] = ...) -> None: ...
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    FAILURE_FIELD_NUMBER: _ClassVar[int]
    success: CreateScenarioResponse.Success
    failure: CreateScenarioResponse.Failure
    def __init__(self, success: _Optional[_Union[CreateScenarioResponse.Success, _Mapping]] = ..., failure: _Optional[_Union[CreateScenarioResponse.Failure, _Mapping]] = ...) -> None: ...
