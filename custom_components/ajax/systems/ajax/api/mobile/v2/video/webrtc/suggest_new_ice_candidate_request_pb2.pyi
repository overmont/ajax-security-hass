...
class SuggestNewWebRtcIceCandidateRequest(_message.Message):
    __slots__ = ("video_edge_id", "webrtc_session_id", "candidate", "space_locator")
    ...
    def __init__(self, video_edge_id: _Optional[str] = ..., webrtc_session_id: _Optional[str] = ..., candidate: _Optional[_Union[_ice_candidate_pb2.IceCandidate, _Mapping]] = ..., space_locator: _Optional[_Union[_space_locator_pb2.SpaceLocator, _Mapping]] = ...) -> None: ...
...
class SuggestNewWebRtcIceCandidateResponse(_message.Message):
    ...
    def __init__(self, success: _Optional[_Union[_response_pb2.Success, _Mapping]] = ..., failure: _Optional[_Union[SuggestNewWebRtcIceCandidateResponse.Failure, _Mapping]] = ...) -> None: ...
