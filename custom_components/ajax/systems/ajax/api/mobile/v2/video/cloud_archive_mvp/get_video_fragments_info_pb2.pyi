...
class CloudArchiveGetVideoFragmentsInfoRequest(_message.Message):
    __slots__ = ("video_edge_guid", "channel_guid", "stream_type", "ts_range", "space_id")
    ...
    space_id: str
    def __init__(self, video_edge_guid: _Optional[str] = ..., channel_guid: _Optional[str] = ..., stream_type: _Optional[_Union[_types_pb2.StreamType, str]] = ..., ts_range: _Optional[_Union[_types_pb2.TimestampRange, _Mapping]] = ..., space_id: _Optional[str] = ...) -> None: ...
