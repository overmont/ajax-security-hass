...
class LeaksProtect(_message.Message):
    __slots__ = ("common_part", "siren_triggers", "always_active", "leak_detected", "subtype")
    ...
    def __init__(self, common_part: _Optional[_Union[_common_device_pb2.CommonDevicePart, _Mapping]] = ..., siren_triggers: _Optional[_Iterable[_Union[LeaksProtect.SirenTrigger, str]]] = ..., always_active: bool = ..., leak_detected: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., subtype: _Optional[_Union[LeaksProtect.Subtype, str]] = ...) -> None: ...
