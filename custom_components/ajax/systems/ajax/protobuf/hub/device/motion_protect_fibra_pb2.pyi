...
class MotionProtectFibra(_message.Message):
    ...
    siren_triggers: _containers.RepeatedScalarFieldContainer[MotionProtectFibra.SirenTrigger]
    sensitivity: int
    always_active: bool
    subtype: MotionProtectFibra.Subtype
    def __init__(self, common_part: _Optional[_Union[_common_device_pb2.CommonDevicePart, _Mapping]] = ..., common_fibra_part: _Optional[_Union[_common_fibra_pb2.CommonFibraPart, _Mapping]] = ..., siren_triggers: _Optional[_Iterable[_Union[MotionProtectFibra.SirenTrigger, str]]] = ..., sensitivity: _Optional[int] = ..., always_active: bool = ..., subtype: _Optional[_Union[MotionProtectFibra.Subtype, str]] = ...) -> None: ...
