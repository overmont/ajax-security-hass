...
class MotionProtectPlusFibra(_message.Message):
    __slots__ = ("common_part", "common_fibra_part", "siren_triggers", "sensitivity", "always_active", "subtype")
    ...
    siren_triggers: _containers.RepeatedScalarFieldContainer[MotionProtectPlusFibra.SirenTrigger]
    sensitivity: int
    always_active: bool
    subtype: MotionProtectPlusFibra.Subtype
    def __init__(self, common_part: _Optional[_Union[_common_device_pb2.CommonDevicePart, _Mapping]] = ..., common_fibra_part: _Optional[_Union[_common_fibra_pb2.CommonFibraPart, _Mapping]] = ..., siren_triggers: _Optional[_Iterable[_Union[MotionProtectPlusFibra.SirenTrigger, str]]] = ..., sensitivity: _Optional[int] = ..., always_active: bool = ..., subtype: _Optional[_Union[MotionProtectPlusFibra.Subtype, str]] = ...) -> None: ...
