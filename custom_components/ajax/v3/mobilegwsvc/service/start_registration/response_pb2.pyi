...
class StartRegistrationResponse(_message.Message):
    ...
    class Failure(_message.Message):
        __slots__ = ("bad_request", "email_validation_failed", "phone_validation_failed", "verification_captcha_failed", "cannot_send_confirmation_codes")
        ...
        def __init__(self, bad_request: _Optional[_Union[_response_pb2.Error, _Mapping]] = ..., email_validation_failed: _Optional[_Union[_response_pb2.Error, _Mapping]] = ..., phone_validation_failed: _Optional[_Union[_response_pb2.Error, _Mapping]] = ..., verification_captcha_failed: _Optional[_Union[_response_pb2.Error, _Mapping]] = ..., cannot_send_confirmation_codes: _Optional[_Union[_response_pb2.Error, _Mapping]] = ...) -> None: ...
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    FAILURE_FIELD_NUMBER: _ClassVar[int]
    success: StartRegistrationResponse.Success
    failure: StartRegistrationResponse.Failure
    def __init__(self, success: _Optional[_Union[StartRegistrationResponse.Success, _Mapping]] = ..., failure: _Optional[_Union[StartRegistrationResponse.Failure, _Mapping]] = ...) -> None: ...
