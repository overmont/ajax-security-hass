...
class DeviceCommandInterconnectWithoutHubTestResponse(_message.Message):
    ...
    class Failure(_message.Message):
        __slots__ = ("command_not_performed", "permission_denied", "hub_wrong_state", "hub_offline", "unknown_command", "hub_error")
    ...
    def __init__(self, success: _Optional[_Union[_response_pb2.Success, _Mapping]] = ..., failure: _Optional[_Union[DeviceCommandInterconnectWithoutHubTestResponse.Failure, _Mapping]] = ...) -> None: ...
