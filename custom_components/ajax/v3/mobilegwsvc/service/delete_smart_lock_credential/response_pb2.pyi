...
class DeleteSmartLockCredentialResponse(_message.Message):
    ...
    class Failure(_message.Message):
        __slots__ = ("hub_offline", "hub_wrong_state", "command_not_performed", "delivered_was_already_performed", "permission_denied", "object_not_found", "hub_busy", "cannot_delete_last_credential", "hub_error", "bad_request")
