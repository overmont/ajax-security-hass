...
class SetVideoEdgeOnvifUserAuthEnabledResponse(_message.Message):
    ...
    def __init__(self, success: _Optional[_Union[SetVideoEdgeOnvifUserAuthEnabledResponse.Success, _Mapping]] = ..., failure: _Optional[_Union[SetVideoEdgeOnvifUserAuthEnabledResponse.Failure, _Mapping]] = ...) -> None: ...
