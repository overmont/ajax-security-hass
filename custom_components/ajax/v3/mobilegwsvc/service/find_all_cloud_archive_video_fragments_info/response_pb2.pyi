...
class FindAllCloudArchiveVideoFragmentsInfoResponse(_message.Message):
    ...
    class Success(_message.Message):
        ...
        class VideoFragmentInfo(_message.Message):
            ...
            def __init__(self, fragment_id: _Optional[int] = ..., timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., duration: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ...) -> None: ...
        FRAGMENTS_INFO_FIELD_NUMBER: _ClassVar[int]
        TIME_ZONE_MAP_FIELD_NUMBER: _ClassVar[int]
        fragments_info: _containers.RepeatedCompositeFieldContainer[FindAllCloudArchiveVideoFragmentsInfoResponse.Success.VideoFragmentInfo]
        time_zone_map: _containers.RepeatedCompositeFieldContainer[_time_zone_pb2.TimeZone]
        def __init__(self, fragments_info: _Optional[_Iterable[_Union[FindAllCloudArchiveVideoFragmentsInfoResponse.Success.VideoFragmentInfo, _Mapping]]] = ..., time_zone_map: _Optional[_Iterable[_Union[_time_zone_pb2.TimeZone, _Mapping]]] = ...) -> None: ...
    ...
    def __init__(self, success: _Optional[_Union[FindAllCloudArchiveVideoFragmentsInfoResponse.Success, _Mapping]] = ..., failure: _Optional[_Union[FindAllCloudArchiveVideoFragmentsInfoResponse.Failure, _Mapping]] = ...) -> None: ...
