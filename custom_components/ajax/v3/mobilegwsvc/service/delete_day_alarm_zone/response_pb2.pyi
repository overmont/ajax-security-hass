...
class DeleteDayAlarmZoneResponse(_message.Message):
    ...
    class Failure(_message.Message):
        __slots__ = ("bad_request", "permission_denied", "hub_offline", "hub_error", "hub_busy", "hub_wrong_state", "illegal_argument")
    ...
    def __init__(self, success: _Optional[_Union[_response_pb2.Success, _Mapping]] = ..., failure: _Optional[_Union[DeleteDayAlarmZoneResponse.Failure, _Mapping]] = ...) -> None: ...
