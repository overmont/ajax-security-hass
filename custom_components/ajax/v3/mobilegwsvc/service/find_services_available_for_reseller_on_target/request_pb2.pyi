...
class FindServicesAvailableForResellerOnTargetRequest(_message.Message):
    __slots__ = ("feature_target_id", "feature_target", "reseller_id")
    ...
    reseller_id: str
    def __init__(self, feature_target_id: _Optional[str] = ..., feature_target: _Optional[_Union[_feature_target_pb2.FeatureTarget, str]] = ..., reseller_id: _Optional[str] = ...) -> None: ...
