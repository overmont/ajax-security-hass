...
class GetVideoEdgeLocalUsersResponse(_message.Message):
    ...
    class Success(_message.Message):
        ...
        local_users: _containers.RepeatedCompositeFieldContainer[_local_user_pb2.LocalUser]
        def __init__(self, local_users: _Optional[_Iterable[_Union[_local_user_pb2.LocalUser, _Mapping]]] = ...) -> None: ...
    class Failure(_message.Message):
        __slots__ = ("bad_request", "space_not_found", "space_armed", "permission_denied", "video_edge_is_offline", "command_not_supported")
    ...
    def __init__(self, success: _Optional[_Union[GetVideoEdgeLocalUsersResponse.Success, _Mapping]] = ..., failure: _Optional[_Union[GetVideoEdgeLocalUsersResponse.Failure, _Mapping]] = ...) -> None: ...
