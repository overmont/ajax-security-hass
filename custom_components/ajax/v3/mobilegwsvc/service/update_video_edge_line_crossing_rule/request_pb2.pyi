...
class UpdateVideoEdgeLineCrossingRuleRequest(_message.Message):
    __slots__ = ("space_id", "video_edge_id", "channel_id", "rule_id", "name", "points", "direction", "object_classes")
