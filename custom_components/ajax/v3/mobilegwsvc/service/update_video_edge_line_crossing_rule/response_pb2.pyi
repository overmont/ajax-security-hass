...
class UpdateVideoEdgeLineCrossingRuleResponse(_message.Message):
    ...
    class Failure(_message.Message):
        __slots__ = ("bad_request", "space_not_found", "space_armed", "permission_denied", "video_edge_not_found", "channel_not_found", "line_crossing_settings_not_found", "rule_not_found", "video_edge_is_offline", "name_already_exists")
