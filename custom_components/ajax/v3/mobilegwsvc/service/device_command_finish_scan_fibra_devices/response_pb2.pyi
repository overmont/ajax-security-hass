...
class DeviceCommandFinishScanFibraDevicesResponse(_message.Message):
    ...
    def __init__(self, success: _Optional[_Union[_response_pb2.Success, _Mapping]] = ..., failure: _Optional[_Union[DeviceCommandFinishScanFibraDevicesResponse.Failure, _Mapping]] = ...) -> None: ...
