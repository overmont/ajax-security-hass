...
class FindAllZombieChannelsOnVideoEdgeResponse(_message.Message):
    ...
    class Success(_message.Message):
        ...
        channels: _containers.RepeatedCompositeFieldContainer[FindAllZombieChannelsOnVideoEdgeResponse.Success.ZombieChannel]
        def __init__(self, channels: _Optional[_Iterable[_Union[FindAllZombieChannelsOnVideoEdgeResponse.Success.ZombieChannel, _Mapping]]] = ...) -> None: ...
    ...
    def __init__(self, success: _Optional[_Union[FindAllZombieChannelsOnVideoEdgeResponse.Success, _Mapping]] = ..., failure: _Optional[_Union[FindAllZombieChannelsOnVideoEdgeResponse.Failure, _Mapping]] = ...) -> None: ...
