...
class UpdatePermanentVideoEdgeChannelPermissionsForCompanyRequest(_message.Message):
    __slots__ = ("space_locator", "company_hex_id", "video_edge_id", "channel_id", "updates", "policy")
