...
class HubCommandEn54HubActionResponse(_message.Message):
    ...
    def __init__(self, success: _Optional[_Union[_response_pb2.Success, _Mapping]] = ..., failure: _Optional[_Union[HubCommandEn54HubActionResponse.Failure, _Mapping]] = ...) -> None: ...
