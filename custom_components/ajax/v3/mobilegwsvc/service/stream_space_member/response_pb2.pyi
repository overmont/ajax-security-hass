...
class StreamSpaceMemberResponse(_message.Message):
    ...
    class Success(_message.Message):
        ...
        class Snapshot(_message.Message):
            ...
            def __init__(self, space_member: _Optional[_Union[_space_member_pb2.SpaceMember, _Mapping]] = ...) -> None: ...
        class Update(_message.Message):
            __slots__ = ("space_member", "update_type")
            class UpdateType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                __slots__ = ()
                UPDATE_TYPE_UNSPECIFIED: _ClassVar[StreamSpaceMemberResponse.Success.Update.UpdateType]
                UPDATE_TYPE_ADD: _ClassVar[StreamSpaceMemberResponse.Success.Update.UpdateType]
                UPDATE_TYPE_UPDATE: _ClassVar[StreamSpaceMemberResponse.Success.Update.UpdateType]
                UPDATE_TYPE_REMOVE: _ClassVar[StreamSpaceMemberResponse.Success.Update.UpdateType]
            ...
            def __init__(self, space_member: _Optional[_Union[_space_member_pb2.SpaceMember, _Mapping]] = ..., update_type: _Optional[_Union[StreamSpaceMemberResponse.Success.Update.UpdateType, str]] = ...) -> None: ...
        SNAPSHOT_FIELD_NUMBER: _ClassVar[int]
        UPDATE_FIELD_NUMBER: _ClassVar[int]
        snapshot: StreamSpaceMemberResponse.Success.Snapshot
        update: StreamSpaceMemberResponse.Success.Update
        def __init__(self, snapshot: _Optional[_Union[StreamSpaceMemberResponse.Success.Snapshot, _Mapping]] = ..., update: _Optional[_Union[StreamSpaceMemberResponse.Success.Update, _Mapping]] = ...) -> None: ...
    ...
    def __init__(self, success: _Optional[_Union[StreamSpaceMemberResponse.Success, _Mapping]] = ..., failure: _Optional[_Union[StreamSpaceMemberResponse.Failure, _Mapping]] = ...) -> None: ...
