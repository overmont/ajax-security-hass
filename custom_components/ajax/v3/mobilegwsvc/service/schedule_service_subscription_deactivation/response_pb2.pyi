...
class ScheduleServiceSubscriptionDeactivationResponse(_message.Message):
    ...
    def __init__(self, success: _Optional[_Union[ScheduleServiceSubscriptionDeactivationResponse.Success, _Mapping]] = ..., failure: _Optional[_Union[ScheduleServiceSubscriptionDeactivationResponse.Failure, _Mapping]] = ...) -> None: ...
